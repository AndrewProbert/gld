...
<html>
  ...
  <tr>
    <td>Price Momentum Score (RSI-based)</td>
    <td><?php echo RSI($symbol); ?></td>
  </tr>
  <tr>
    <td>Price Momentum Score (MACD-based)</td>
    <td><?php echo MACD($symbol); ?></td>
  </tr>
  <tr>
    <td>On-Balance Volume Score</td>
    <td><?php echo calculateOBVScore($symbol); ?></td>
  </tr>
  <tr>
    <td>Average Directional Index (ADX)</td>
    <td><?php echo calculateADX($symbol); ?></td>
  </tr>
  <tr>
    <td>Final Score</td>
    <td><?php echo calculateFinalScore($symbol); ?></td>
  </tr>
</table>
